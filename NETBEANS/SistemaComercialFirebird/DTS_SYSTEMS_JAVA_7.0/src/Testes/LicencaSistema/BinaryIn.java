 ...
 * binary input stream, either one bit at a time (as a boolean), 8 bits at a
 * time (as a byte or char), 16 bits at a time (as a short), 32 bits at a time
 * (as an int or float), or 64 bits at a time (as a double or long).
 * <p>
 ...
 * <p>
 * The client should not intermix calls to BinaryIn with calls to In; otherwise
...
public final class BinaryIn {
     ...
     *
     * @param r number of bits to read.
     * @return the next r bits of data from the binary input stream as an int.
     * @throws RuntimeException if there are fewer than r bits available on
     * standard input
     */
     ...
     * long.
     *
     * @return the next 64 bits of data from the binary input stream as a long.
     ...
     * byte.
     *
     * @return the next 8 bits of data from the binary input stream as a byte.
     * @throws RuntimeException if there are fewer than 8 bits available.
     */
