/**
 * ***********************************************************************
 * Compilation: javac BinaryOut.java Execution: java BinaryOut
 *
 ...
 *
 * [wayne 7.17.2013] fixed bugs in write(char x, int r) and write(int x, int r)
 * to add return statement for (r == 8) and (r == 32) cases, respectively.
 *
 ************************************************************************
 */
...
/**
 * Binary output. This class provides methods for converting primitive type
 * variables (boolean, byte, char, int, long, float, and double) to sequences of
 * bits and writing them to an output stream. The output stream can be standard
 * output, a file, an OutputStream or a Socket. Uses big-endian
 * (most-significant byte first).
 * <p>
 * The client must flush() the output stream when finished writing bits.
 * <p>
 * The client should not intermix calls to BinaryOut with calls to Out;
