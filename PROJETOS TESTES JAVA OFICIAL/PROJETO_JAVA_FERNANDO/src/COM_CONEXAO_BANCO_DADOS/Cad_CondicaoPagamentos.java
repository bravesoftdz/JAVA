 ...
 * @author Fernando
 */
public class Cad_CondicaoPagamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 140, -1));
    ...
    private void jTextField2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyPressed
        if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_TAB)){
            if (jTextField2.getText().equals("")){
                jTextField2.setText(String.valueOf(cond.retornaUltimo()));
                habilitaCampos(true);
                jTextField3.requestFocus();
                cond.setAlteracao(false);
            } else {
                cond.setCodigo(Integer.parseInt(jTextField2.getText()));
            
                if (cond.procurarProduto()){
                    jTextField3.setText(cond.getDescricao());
                    cond.setAlteracao(true);
...
//            if (resposta == 0){
//                if (cond.GravarAlterar(Integer.parseInt(jTextField2.getText()), jTextField3.getText(), 
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cad_CondicaoPagamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Cad_CondicaoPagamentos().setVisible(true);
            }
        });
    }
